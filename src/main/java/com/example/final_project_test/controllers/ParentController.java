...
public class ParentController {
	...
	// Dodaj novi
	@PostMapping(value = "/")
	public ResponseEntity<?> createNew(@RequestBody ParentEntity parentEntity) {
		return new ResponseEntity<ParentEntity>(parentRepository.save(parentEntity), HttpStatus.OK);
	}
